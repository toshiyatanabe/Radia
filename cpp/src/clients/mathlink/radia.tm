...
:Evaluate:      radObjCylMag::usage = "radObjCylMag[{x,y,z},r,h,nseg,a:\"z\",{mx,my,mz}:{0,0,0}] creates a cylindrical magnet approximated by a straight prism with a right polygon in base with center point {x,y,z}, base radius r, height h, number of segments nseg, orientation of the rotation axis defined by character a (which can be \"x\", \"y\" or \"z\"), and magnetization vector {mx,my,mz}."
...
:Evaluate:      radObjCnt::usage = "radObjCnt[{obj1,obj2,...}] creates a container object for magnetic field source objects {obj1,obj2,...}."
